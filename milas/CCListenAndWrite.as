...
package com.matbury.milas {
	...
	public class CCListenAndWrite extends Sprite {
		
		private var _version:String = "2011.10.20";
		...
		public function CCListenAndWrite() {
		...
		*/
		private function sendGrade():void {
			...
			obj.feedback = _wordsCompleted + "/" + _blanks.length + " " + Lang.WORDS + " " + Lang.COMPLETED_END + "."; // (String) optional
			obj.feedbackformat = _clock.seconds; // (int) elapsed time in seconds
			obj.rawgrade = _percent; // (Number) grade, normally 0 - 100 but depends on grade book settings
