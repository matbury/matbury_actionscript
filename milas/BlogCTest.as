/*
    BlogCTest Multimedia Interactive Learning Application (MILA).
	...
	public class BlogCTest extends Sprite {
		...
		*/
		...
		private function copyUp(event:MouseEvent):void {
			_copy.label = "Copied";
			_copyText = "C-Test\n\n" + _copyText + "\n\nThis test was generated by C-Test app © Matt Bury 2012  | matbury.com at http://blog.matbury.com/2013/01/10/free-online-interactive-c-test-generator/\n\nPlease check that you have appropriate permission from the copyright holder to reproduce the text used to generate this test.";
